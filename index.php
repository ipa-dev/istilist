                        ...
                        <?php } ?> 
                            ...
                            <div class="box_actions">
                                <ul>
                                    ...
                                    <li><a href="#stylistpopup" <?php $assign_stylist = get_post_meta($shopper_id, 'assign_stylist', TRUE); if (!empty($assign_stylist)) echo "style='color:#14b9d6'"; ?> class="assignStylist" rel="<?php echo $shopper_id; ?>"><i class="icon-clothes4"></i></a></li>
                                    ...
                                    <li>
                                        <form method="post" action="">
                                            ...
                                            <input class="submitbtnimg" type="submit" <?php $timestamps = get_post_meta($shopper_id, 'timestamps', TRUE); if (!empty($timestamps)) echo "style='color:#14b9d6'"; ?> name="plusbtn" value="&#xf067;" />
                                        </form> 
                                    </li>
