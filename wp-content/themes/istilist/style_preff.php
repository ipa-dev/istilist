...
<div class="timeframe">
    <ul>
        <li class="<?php if($st_active_section == 'st-year'){ echo 'activeSection'; } ?>"><a href="<?php bloginfo('url'); ?>/analytics-reporting/?st=<?php echo encripted('st-year'); ?>">Year</a></li>
        <li class="<?php if($st_active_section == 'st-lastmonth'){ echo 'activeSection'; } ?>"><a href="<?php bloginfo('url'); ?>/analytics-reporting/?st=<?php echo encripted('st-lastmonth'); ?>">Last Month</a></li>
        <li class="<?php if($st_active_section == 'st-thismonth'){ echo 'activeSection'; } ?>"><a href="<?php bloginfo('url'); ?>/analytics-reporting/?st=<?php echo encripted('st-thismonth'); ?>">This Month</a></li>
        <li class="<?php if($st_active_section == 'st-7days'){ echo 'activeSection'; } ?>"><a href="<?php bloginfo('url'); ?>/analytics-reporting/?st=<?php echo encripted('st-7days'); ?>">Last 7 Days</a></li>
        <li class="<?php if($st_active_section == 'st-today'){ echo 'activeSection'; } ?>"><a href="<?php bloginfo('url'); ?>/analytics-reporting/?st=<?php echo encripted('st-today'); ?>">Today</a></li>
        <li class="<?php if($st_active_section == 'st-custom'){ echo 'activeSection'; } ?>"><a href="<?php bloginfo('url'); ?>/analytics-reporting/?st=<?php echo encripted('st-custom'); ?>">Custom</a></li>
    </ul>
</div>
