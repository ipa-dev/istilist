                        ...
                        <form id="forms" method="post" action="" enctype="multipart/form-data">
                                ...
                                <?php if(check_is_active('graduation_year') == 1){ ?>
                                    <div class="col span_6_of_12 matchheight">
                                        ...
                                        <select name="graduation_year">
                                            ...
                                            <option value="<?php echo $i; ?>" <?php if(get_post_meta($shopper_id, 'graduation_year', true) == $i){ echo 'selected="selected"'; } ?>><?php echo $i; ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                <?php } ?>
                            ...
                            <div class="section group">
                                <div class="col span_12_of_12">
                                    <input type="checkbox" name="sms_agreement" value="yes" <?php if(get_post_meta($shopper_id, 'sms_agreement', true) == 'yes'){ echo 'checked="checked"'; } ?> /> Yes, I want istilist texts!<br /><br />
                            ...
                            <div class="section group form_list">
                                ...
                                <div class="col span_6_of_12 matchheight">
                                    ...
                                    <select name="design_preferences">
                                        ...
                                        <option value="<?php the_title(); ?>" <?php if($design_preferences == get_the_title(get_the_ID())){ echo 'selected="selected"'; } ?>><?php the_title(); ?></option>
                                        <?php $i++; ?>
                                        <?php endwhile; ?>
                                        <?php } ?>
                                    </select>
                                ...
                                <div class="col span_6_of_12 matchheight">
                                    ...
                                    <option value="<?php the_title(); ?>" <?php if(get_post_meta($shopper_id, 'style_preferences', true) == get_the_title(get_the_ID())){ echo 'selected="selected"'; } ?>><?php the_title(); ?></option>
                                    <?php $i++; ?>
                                    <?php endwhile; ?>
                                    <?php } ?>
                                    </select>
                                ...
                                <div class="col span_6_of_12 matchheight">
                                    ...
                                    <?php //$i++; ?>
                                    <option value="<?php the_title(); ?>" <?php if(get_post_meta($shopper_id, 'color_preferences', true) == get_the_title(get_the_ID())){ echo 'selected="selected"'; } ?>><?php the_title(); ?></option>
                                    <?php endwhile; ?>
                                    <?php } ?>
                                    </select>
                                    <?php wp_reset_postdata(); ?>
                                ...
                                <div class="col span_6_of_12 matchheight">
                                    ...
                                    <select name="customer_size">
                                        ...
                                        <option value="<?php the_title(); ?>" <?php if(get_post_meta($shopper_id, 'customer_size', true) == get_the_title(get_the_ID())){ echo 'selected="selected"'; } ?>><?php the_title(); ?></option>
                                        <?php endwhile; ?>
                                        <?php } ?>
                                    </select>
                                    <?php wp_reset_postdata(); ?>
                           ...
                           <?php if(check_is_active($r2->form_slug) == 1){ ?>
                            <div class="col span_6_of_12">
                                <label><?php echo $r2->form_display_name; ?> <?php if($r2->is_required == 1){ ?><span>*</span><?php } ?></label>
                           ...
                           <?php } ?>
                            ...
                            <div class="section group">
                                <div class="col span_12_of_12">
                                    ...
                                    <textarea name="shoppers_feedback"><?php $post = get_page($shopper_id); $content = apply_filters('the_content', $post->post_content); echo strip_tags($content); ?></textarea>
                                </div>
                            </div>
                            <div class="section group">
                                <div class="col span_12_of_12">
