          ...
          if (($this->pages) > 1) {
              ...
              if ($this->page != 1) {
                  if ($this->_showFirstAndLast) {
                      $plinks[] = ' <a href="?pageno=1'.$queryUrl.'">&laquo;&laquo; First </a> ';
                  }
                  $plinks[] = ' <a href="?pageno='.($this->page - 1).$queryUrl.'">&laquo; Prev</a> ';
              }
              ...
              for ($j = 1; $j < ($this->pages + 1); $j++) {
                  if ($this->page == $j) {
                      ...
                      $links[] = ' <a href="?pageno='.$j.$queryUrl.'">'.$j.'</a> '; // add the link to the array
                  }
              }

              // Assign the 'next page' if we are not on the last page
              if ($this->page < $this->pages) {
                  $slinks[] = ' <a href="?pageno='.($this->page + 1).$queryUrl.'"> Next &raquo; </a> ';
                  if ($this->_showFirstAndLast) {
                      $slinks[] = ' <a href="?pageno='.($this->pages).$queryUrl.'"> Last &raquo;&raquo; </a> ';
                  }
              }
