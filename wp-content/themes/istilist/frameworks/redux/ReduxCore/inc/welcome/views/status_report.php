...
<div class="wrap about-wrap redux-status">
        ...
        <div id="debug-report">
            ...
            <p class="submit">
                <button id="copy-for-support" class="button-primary redux-hint-qtip" href="#"
                        qtip-content="<?php _e('Copied!', 'redux-framework'); ?>"><?php _e('Copy for Support', 'redux-framework'); ?></button>
            </p>
        </div>
    </div>
    <br/>
    <table class="redux_status_table widefat" cellspacing="0" id="status">
        ...
        <tr>
            <th colspan="3"
                data-export-label="WordPress Environment"><?php _e('WordPress Environment', 'redux-framework'); ?></th>
        </tr>
        </thead>
        <tbody>
        <tr>
        ...
        <tr>
            <td data-export-label="Redux Data Directory Writable"><?php _e('Redux Data Directory Writable', 'redux-framework'); ?>
                :
            </td>
    ...
    <table class="redux_status_table widefat" cellspacing="0" id="status">
        ...
        <tr>
            <th colspan="3"
                data-export-label="Server Environment"><?php _e('Server Environment', 'redux-framework'); ?></th>
        </tr>
        </thead>
        <tbody>
        <tr>
        ...
        <tr>
            <td data-export-label="Default Timezone is UTC"><?php _e('Default Timezone is UTC', 'redux-framework'); ?>
                :
            </td>
    ...
    <table class="redux_status_table widefat" cellspacing="0" id="status">
        ...
        <tr>
            <th colspan="3"
                data-export-label="Active Plugins (<?php echo count((array) get_option('active_plugins')); ?>)"><?php _e('Active Plugins', 'redux-framework'); ?>
        ...
        if (! empty($sysinfo['redux_instances']) && is_array($sysinfo['redux_instances'])) {
            foreach ($sysinfo['redux_instances'] as $inst => $data) {
                ...
                <table class="redux_status_table widefat" cellspacing="0" id="status">
                    ...
                    <tr>
                        <th colspan="3"
                            data-export-label="Redux Instance: <?php echo $inst_name; ?>"><?php _e('Redux Instance: ', 'redux-framework');
                echo $inst_name; ?></th>
                    </tr>
                    </thead>
                    <tbody>
    ...
    <table class="redux_status_table widefat" cellspacing="0" id="status">
        ...
        <?php
            ...
            if (is_child_theme()) {
                ?>
                <tr>
                    <td data-export-label="Parent Theme Name"><?php _e('Parent Theme Name', 'redux-framework'); ?>:
                    </td>
                ...
                <tr>
                    <td data-export-label="Parent Theme Version"><?php _e('Parent Theme Version', 'redux-framework'); ?>
                        :
                    </td>
                ...
                <tr>
                    <td data-export-label="Parent Theme Author URL"><?php _e('Parent Theme Author URL', 'redux-framework'); ?>
                        :
                    </td>
