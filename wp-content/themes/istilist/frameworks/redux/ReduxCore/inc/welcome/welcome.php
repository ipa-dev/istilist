    ...
    class Redux_Welcome
    {
        ...
        public function check_version()
        {
            ...
            if ($compare) {
                ...
                } elseif (version_compare($curVer, $saveVer, '>')) {
        ...
        public function admin_menus()
        {
            ...
            add_management_page(
                ...
                __('Redux Framework', 'redux-framework'),
            ...
            // Support Page
            add_management_page(
                __('Get Support', 'redux-framework'),
                __('Get Support', 'redux-framework'),
                $this->minimum_capability,
                'redux-support',
                array(
            ...
            // Status Page
            add_management_page(
                __('Redux Framework Status', 'redux-framework'),
                __('Redux Framework Status', 'redux-framework'),
                $this->minimum_capability,
                'redux-status',
                array(
        ...
        public function contributors()
        {
            ...
            foreach ($contributors as $contributor) {
                ...
                $contributor_list .= sprintf(
                    ...
                    esc_html(sprintf(__('View %s', 'redux-framework'), $contributor->login))
                );
