        ...
        class reduxCorePanel
        {
            ...
            public function notification_bar()
            {
                if (isset($this->parent->transients['last_save_mode'])) {
                    ...
                    //exit();
                    } elseif ($this->parent->transients['last_save_mode'] == "defaults") {
                        /**
                    ...
                    } elseif ($this->parent->transients['last_save_mode'] == "defaults_section") {
                        /**
                    ...
                    } elseif ($this->parent->transients['last_save_mode'] == "normal") {
                        /**
             ...
             */
            public function output_section($k)
            {
