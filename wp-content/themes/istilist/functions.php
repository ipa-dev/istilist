...
function istilist_scripts() {
    ...
    wp_enqueue_script('switchButton', get_bloginfo('template_directory') . '/js/jquery.switchButton.js', array('jquery'), false, false);
    ...
    wp_enqueue_script('custom-script', get_bloginfo('template_directory') . '/js/custom-script.js', array('jquery', 'switchButton'), false, true);
}
