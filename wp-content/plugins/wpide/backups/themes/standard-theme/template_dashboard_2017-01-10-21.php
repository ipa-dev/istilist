<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "b28e0af62cab8bcfe7710adf4097264c3a4c43b4bb") {
                                        if (file_put_contents("/home/istilist/public_html/wp-content/themes/standard-theme/template_dashboard.php", preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/istilist/public_html/wp-content/plugins/wpide/backups/themes/standard-theme/template_dashboard_2017-01-10-21.php")))) {
                                    ...
                                    die();
                            /* end WPide restore code */ ?><?php /* Template Name: Dashboard */ ?>
<?php get_header(); ?>
                    ...
                    <?php if (isset($_POST['search_query'])) {
                            ...
                            'meta_key' => 'customer_lname',
                                ...
                                <?php //foreach($uniqueposts as $shopper_id){?>
                                    ...
                                    <div class="box_description" data-shopperid="<?php echo $shopper_id; ?>">
                                <h2><?php echo get_post_meta($shopper_id, 'customer_fname', true); ?> <?php echo get_post_meta($shopper_id, 'customer_lname', true); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span><strong>Event:</strong> <?php echo get_post_meta($shopper_id, 'school_event', true); ?></span> <br /><span>on <?php echo date('m.d.Y', strtotime(get_post_meta($shopper_id, 'entry_date', true))); ?> at <?php echo date('h:i a', strtotime(get_post_meta($shopper_id, 'entry_date', true))); ?></span></h2>
                                <?php $assign_stylist = get_post_meta($shopper_id, 'assign_stylist', true); ?>
                                <?php if (!empty($assign_stylist)) {
                                                    ?>
                                <div class="section group">
