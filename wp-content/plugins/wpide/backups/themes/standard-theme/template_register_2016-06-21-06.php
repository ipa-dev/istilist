<?php /* start WPide restore code */
                                    ...
                                    die();
                            /* end WPide restore code */ ?><?php /* Template Name: Register */ ?>
<?php get_header(); ?>
<?php global $options; ?>
                        ...
                        if (isset($_POST['register'])) {
                            ...
                            if (email_exists($email_addr[0])) {
                                ...
                                $msg ='<strong>New User registered</strong><br><br><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                          ...
                                          <tr>
                                            <td></td>
                                            <td><a href="'.get_bloginfo('url').'/approve-user/?udi='.$new_user_id.'" style="display:inline-block; padding:8px 15px; background:#006400; color:#ffffff;">Approve</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="'.get_bloginfo('url').'/decline-user/?udi='.$new_user_id.'" style="display:inline-block; padding:8px 15px; background:#800000; color:#ffffff;">Decline</a></td>
                                          </tr>
