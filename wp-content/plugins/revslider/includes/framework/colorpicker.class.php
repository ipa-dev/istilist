    ...
    class TPColorpicker
    {
        ...
        public static function convert($color, $opacity)
        {
            ...
            if (strpos($color, "[{") !== false  || strpos($color, 'gradient') !== false) {
                return TPColorpicker::get($color);
            }
        ...
        public static function process($clr, $processColor = false)
        {
            ...
            if (!is_string($clr)) {
                if ($processColor) {
                    $clr = TPColorpicker::sanatizeGradient($clr);
                }
            ...
            } elseif (strpos($clr, 'rgb') !== false) {
                $clr = preg_replace('/\s+/', '', $clr);
                return array($clr, 'rgb');
            } elseif (preg_match(TPColorpicker::$isColor, $clr) !== false) {
                $clr = preg_replace('/\s+/', '', $clr);
