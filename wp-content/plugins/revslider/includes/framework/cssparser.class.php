...
class RevSliderCssParser
{
                ...
                if (is_array($styles)) {
                    foreach ($styles as $name => $style) {
                        if (in_array($name, $deformations)) {
                            if ($name !== 'css_cursor' && $name !== 'pointer_events') {
                                continue;
                            }
                        }
                        ...
                        if ($ret['name'] == 'pointer-events' && $ret['style'] == 'auto') {
                            continue;
                        }
    ...
    public static function check_for_modifications($name, $style)
    {
        if ($name == 'css_cursor') {
            if ($style == 'zoom-in') {
                $style = 'zoom-in; -webkit-zoom-in; cursor: -moz-zoom-in';
            }
            if ($style == 'zoom-out') {
                $style = 'zoom-out; -webkit-zoom-out; cursor: -moz-zoom-out';
            }
            $name = 'cursor';
        }
