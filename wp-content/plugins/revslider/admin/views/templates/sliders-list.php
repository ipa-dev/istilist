...
<ul class="tp-list_sliders">
        ...
        foreach ($arrSliders as $slider) {
			...
			<li class="tls-slide tls-stype-all tls-stype-<?php echo $slider_type; ?>" data-favorit="<?php echo ($is_favorite) ? 'a' : 'b'; ?>" data-id="<?php echo $id; ?>" data-name="<?php echo $title; ?>" data-type="<?php echo $slider_type; ?>">
				<div class="tls-main-metas">
					...
					<span class="tls-firstslideimage <?php echo $first_slide_image_thumb['class']; ?>" style="<?php echo $first_slide_image_thumb['style']; ?>;<?php if (!empty($first_slide_image_thumb['url'])) {
                ?>background-image:url( <?php echo $first_slide_image_thumb['url']; ?>) <?php
            } ?>"></span>
					...
					<span class="tls-slidenr"><?php echo $numSlides;
            if ($numReal !== '') {
                echo ' ('.$numReal.')';
            } ?></span>
	...
	<?php if (!RevSliderFunctionsWP::isAdminUser() && apply_filters('revslider_restrict_role', true)) {
    } else {
        ?>
		<li class="tls-slide tls-addnewslider">
