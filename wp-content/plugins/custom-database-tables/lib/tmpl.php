...
trait DynamicTemplate
{
    ...
    public function component_render($component_name, $options=null)
    {
        ...
        $this->$component_render_method = function () {
...
?>
    <div class="form-group <?php echo $wrapper_classes; ?>">
      <label for="<?php echo esc_attr($field_id); ?>" class="col-sm-<?php echo $label_size; ?> control-label"><?php echo $field_label; ?><?php if ($is_required) {
    echo $label_required;
} ?><?php echo $label_state; ?></label>
      <div class="col-sm-<?php echo $field_size; ?>">
        <input id="<?php echo esc_attr($field_id); ?>" name="<?php echo $this->domain_name; ?>[<?php echo esc_attr($field_option['elementName']); ?>]" type="<?php echo esc_attr($field_option['elementType']); ?>" value="<?php echo esc_attr($field_option['defaultValue']); ?>" class="form-control <?php echo esc_attr($add_classes); ?>" placeholder="<?php echo $placeholder; ?>" <?php echo $add_attributes; ?><?php if ($is_required) {
    echo ' required';
} ?>>
      </div>
    ...
    echo $label_required;
      ...
      <div class="col-sm-<?php echo $max_field_size; ?>">
        <div class="spinbox disits-<?php echo $field_size; ?> <?php echo esc_attr($add_classes); ?>" data-initialize="spinbox" id="<?php echo esc_attr($field_id); ?>">
          <input type="text" name="<?php echo $this->domain_name; ?>[<?php echo esc_attr($field_option['elementName']); ?>]" value="<?php echo esc_attr($field_option['defaultValue']); ?>" class="form-control input-mini spinbox-input" placeholder="<?php echo $placeholder; ?>" <?php echo $add_attributes; ?><?php if ($is_required) {
    echo ' required';
} ?>>
...
?>
    ...
    echo $label_required;
      ...
      <div class="col-sm-<?php echo $field_size; ?>">
        <textarea id="<?php echo esc_attr($field_id); ?>" name="<?php echo $this->domain_name; ?>[<?php echo esc_attr($field_option['elementName']); ?>]" class="form-control <?php echo esc_attr($add_classes); ?>" placeholder="<?php echo $placeholder; ?>" <?php echo $add_attributes; ?><?php if ($is_required) {
    echo ' required';
} ?>><?php echo $field_option['defaultValue']; ?></textarea>
      </div>
    <?php if (isset($field_option['helperText']) && ! empty($field_option['helperText'])) : ?>
      <div class="col-sm-<?php echo $max_field_size; ?> col-sm-offset-<?php echo $label_size; ?>">
        <p class="help-block"><?php echo $field_option['helperText']; ?></p>
    ...
    echo $label_required;
      ...
      <div class="col-sm-<?php echo $max_field_size; ?>">
        <div class="input-group input-append dropdown combobox col-sm-<?php echo $field_size; ?>" data-initialize="combobox" id="<?php echo esc_attr($field_id); ?>">
          <input type="text" name="<?php echo $this->domain_name; ?>[<?php echo esc_attr($field_option['elementName']); ?>]"<?php if (! $is_selected) : ?> value="<?php echo esc_attr($field_option['defaultValue']); ?>"<?php endif; ?> class="form-control text-center" placeholder="<?php echo $placeholder; ?>" <?php echo $add_attributes; ?><?php if ($is_required) {
    echo ' required';
} ?>>
          <div class="input-group-btn">
            ...
            <?php foreach ($selectable_list as $_key => $_val) : ?>
              <li data-value="<?php echo esc_attr($_key); ?>"<?php if ($is_selected && $field_option['defaultValue'] === $_val) {
    echo ' data-selected="true"';
} ?>><a href="#"><?php echo esc_html($_val); ?></a></li>
            <?php endforeach; ?>
            </ul>
          </div>
        </div>
...
?>
    ...
    echo $label_required;
      ...
      <?php foreach ($selectable_list as $_key => $_val) : $index_num++; ?>
        ...
        <div class="checkbox <?php echo esc_attr($add_classes); ?> <?php if (isset($child_classes[$_key])) {
    echo trim($child_classes[$_key]);
} ?>" id="<?php echo esc_attr($is_multiple ? $field_id . $index_num : $field_id); ?>">
        ...
        <?php else : ?>
        <label class="checkbox-custom checkbox-inline<?php if ($is_multiple) : ?> multiple<?php endif; ?> <?php echo esc_attr($add_classes); ?> <?php if (isset($child_classes[$_key])) {
    echo trim($child_classes[$_key]);
} ?>" data-initialize="checkbox" id="<?php echo esc_attr($is_multiple ? $field_id . $index_num : $field_id); ?>">
...
?>
    ...
    echo $label_required;
      ...
      <?php foreach ($selectable_list as $_key => $_val) : $index_num++; ?>
        <?php if (! $is_horizontal) : ?>
        <div class="radio<?php if ($default_value === $_key) {
    echo ' checked';
} ?><?php echo esc_attr($add_classes); ?> <?php if (isset($child_classes[$_key])) {
    echo trim($child_classes[$_key]);
} ?>" id="<?php echo esc_attr($field_id) . $index_num; ?>">
        ...
        <?php else : ?>
        <label class="radio-custom radio-inline<?php if ($default_value === $_key) {
    echo ' checked';
} ?><?php echo esc_attr($add_classes); ?> <?php if (isset($child_classes[$_key])) {
    echo trim($child_classes[$_key]);
} ?>" data-initialize="radio" id="<?php echo esc_attr($field_id) . $index_num; ?>">
          <input class="sr-only"<?php if ($default_value === $_key) : ?> checked="checked"<?php endif; ?> name="<?php echo $this->domain_name; ?>[<?php echo esc_attr($field_option['elementName']); ?>][]" type="radio" value="<?php echo esc_attr($_key); ?>">
          <span class="radio-label"><?php echo $_val; ?></span>
        </label>
        <?php endif; ?>
...
?>
    <div class="form-group <?php echo $wrapper_classes; ?>">
      <label for="entry-data-<?php echo esc_attr($field_option['elementName']); ?>" class="col-sm-2 control-label"><?php echo $field_option['elementLabel']; ?><?php if ($is_required) {
    echo $label_required;
} ?><?php echo $label_state; ?></label>
      <div class="col-sm-10">
        <div class="checkbox <?php echo esc_attr($field_option['addClass']); ?>" id="entry-data-<?php echo esc_attr($field_option['elementName']); ?>">
          <label class="checkbox-custom" data-initialize="checkbox">
            <input class="sr-only" name="<?php echo $this->domain_name; ?>[<?php echo esc_attr($field_option['elementName']); ?>]" type="checkbox" value="1"<?php echo $checked; ?> <?php echo $add_attributes; ?><?php if ($is_required) {
    echo ' required';
} ?>>
...
?>
    <div class="form-group <?php echo $wrapper_classes; ?>">
      <label for="entry-data-<?php echo esc_attr($field_option['elementName']); ?>-date" class="col-sm-2 control-label"><?php echo $field_option['elementLabel']; ?><?php if ($is_required) {
    echo $label_required;
} ?><?php echo $label_state; ?></label>
      <div class="col-sm-10">
