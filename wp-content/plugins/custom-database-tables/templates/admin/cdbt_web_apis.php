...
<?php if ($current_tab == 'hosts_list') : ?>
  <div class="well-sm">
    <p class="text-info">
      ...
      <?php if (!empty($_allowed_hosts)) {
    _e('Currently list of hosts that was allowed API request is as follows.', CDBT);
} ?><br>
      <?php if (empty($_allowed_hosts)) {
    printf(__('The currently allowed host does not exists. Please %sregister the host%s.', CDBT), '<a href="'. add_query_arg('tab', 'apikey_generator') .'">', '</a>');
} ?>
    </p>
  </div>
  <?php 
  ...
  <div class="cdbt-webapis-options">
    <form method="post" action="<?php echo esc_url(add_query_arg([ 'page' => $this->query['page'] ])); ?>" class="form-horizontal">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-4">
          <input id="register-webapi-host_name" name="<?php echo $this->domain_name; ?>[host_name]" type="text" value="<?php if (isset($this_tab_vars['host_name'])) {
      echo $this_tab_vars['host_name'];
  } ?>" class="form-control" placeholder="<?php _e('Please enter the FQDN or IP address', CDBT); ?>" required>
        </div>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-9">
          <textarea id="register-webapi-description" name="<?php echo $this->domain_name; ?>[description]" class="form-control" rows="2" placeholder="Enter description as meno"><?php if (isset($this_tab_vars['description'])) {
      echo esc_textarea(stripslashes_deep($this_tab_vars['description']));
  } ?></textarea>
        ...
        <div class="col-sm-10">
          <div class="btn-group selectlist" data-resize="auto" data-initialize="selectlist" id="edit-webapi-request-allowed_host">
            ...
            <ul class="dropdown-menu" role="menu">
              <li data-value="" ><a href="#" class="text-muted"><?php if (!empty($_allowed_hosts)) {
    _e('Please choose item', CDBT);
} else {
    _e('Allowed host is none', CDBT);
} ?></a></li>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-10">
          <div class="btn-group selectlist" data-resize="auto" data-initialize="selectlist" id="edit-webapi-request-target_table">
            ...
            <ul class="dropdown-menu" role="menu">
              <li data-value="" ><a href="#" class="text-muted"><?php if (!empty($selectable_table)) {
    _e('Please choose item', CDBT);
} else {
    _e('Selectable table is none', CDBT);
} ?></a></li>
      ...
      <div class="form-group switching-item search-key">
        ...
        <div class="col-sm-9">
          <input id="edit-webapi-request-search_key" name="<?php echo $this->domain_name; ?>[search_key]" type="text" value="<?php if (isset($this_tab_vars['search_key'])) {
    echo $this_tab_vars['search_key'];
      ...
      <div class="form-group switching-item target-columns">
        ...
        <div class="col-sm-9">
          <input id="edit-webapi-request-target_columns" name="<?php echo $this->domain_name; ?>[target_columns]" type="text" value="<?php if (isset($this_tab_vars['target_columns'])) {
    echo $this_tab_vars['target_columns'];
} ?>" class="form-control" placeholder="col1,col2,col3,...">
      ...
      <div class="form-group switching-item conditions">
        ...
        <div class="col-sm-9">
          <input id="edit-webapi-request-conditions" name="<?php echo $this->domain_name; ?>[conditions]" type="text" value="<?php if (isset($this_tab_vars['conditions'])) {
    echo $this_tab_vars['conditions'];
} ?>" class="form-control" placeholder="col1:value1,col2:value2,...">
      ...
      <div class="form-group switching-item upsert_data">
        ...
        <div class="col-sm-9">
          <input id="edit-webapi-request-upsert_data" name="<?php echo $this->domain_name; ?>[upsert_data]" type="text" value="<?php if (isset($this_tab_vars['upsert_data'])) {
    echo $this_tab_vars['upsert_data'];
} ?>" class="form-control" placeholder="col1:value1,col2:value2,...">
      ...
      <div class="form-group switching-item pk_value">
        ...
        <div class="col-sm-3">
          <input id="edit-webapi-request-pk_value" name="<?php echo $this->domain_name; ?>[pk_value]" type="text" value="<?php if (isset($this_tab_vars['pk_value'])) {
    echo $this_tab_vars['pk_value'];
} ?>" class="form-control" placeholder="primary key value">
        </div>
      ...
      <div class="form-group switching-item orders">
        ...
        <div class="col-sm-8">
          <input id="edit-webapi-request-orders" name="<?php echo $this->domain_name; ?>[orders]" type="text" value="<?php if (isset($this_tab_vars['orders'])) {
    echo $this_tab_vars['orders'];
} ?>" class="form-control" placeholder="col1:asc,col2:desc,...">
      ...
      <div class="form-group switching-item limit">
        ...
        <div class="col-sm-10">
          <div class="spinbox disits-3" data-initialize="spinbox" id="edit-webapi-request-limit">
            <input type="text" name="<?php echo $this->domain_name; ?>[limit]" value="<?php if (isset($this_tab_vars['limit'])) {
    echo intval($this_tab_vars['limit']);
      ...
      <div class="form-group switching-item offset">
        ...
        <div class="col-sm-10">
          <div class="spinbox disits-3" data-initialize="spinbox" id="edit-webapi-request-offset">
            <input type="text" name="<?php echo $this->domain_name; ?>[offset]" value="<?php if (isset($this_tab_vars['offset'])) {
    echo intval($this_tab_vars['offset']);
} ?>" class="form-control input-mini spinbox-input">
            <div class="spinbox-buttons btn-group btn-group-vertical">
              <button type="button" class="btn btn-default spinbox-up btn-xs"><span class="glyphicon glyphicon-chevron-up"></span><span class="sr-only"><?php echo __('Increase', CDBT); ?></span></button>
              <button type="button" class="btn btn-default spinbox-down btn-xs"><span class="glyphicon glyphicon-chevron-down"></span><span class="sr-only"><?php echo __('Decrease', CDBT); ?></span></button>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-9">
          <textarea id="edit-webapi-request-generate_uri" name="<?php echo $this->domain_name; ?>[generate_uri]" class="form-control" rows="5" readonly><?php if (isset($this_tab_vars['generate_uri'])) {
    echo esc_textarea(stripslashes_deep($this_tab_vars['generate_uri']));
} ?></textarea>
        </div>
