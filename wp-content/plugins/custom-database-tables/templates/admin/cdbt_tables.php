...
<div id="page-head" name="page-head" class="wrap">
  ...
  <div role="tabpanel">
    ...
    <?php foreach ($tabs as $tab_name => $display_tab_title) : ?>
      <?php if ('wp_core_table' === $tab_name && !$options['enable_core_tables']) {
    continue;
} ?>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-10">
          <div class="input-group col-sm-5" id="create-table-table_name">
            ...
            <input id="instance_table_name" name="instance_table_name" type="text" value="<?php if (isset($session_vars)) {
    echo $session_vars['instance_table_name'];
} ?>" class="form-control" placeholder="<?php _e('Please enter the table name', CDBT); ?>">
            <input name="<?php echo $this->domain_name; ?>[table_name]" type="hidden" value="<?php if (isset($session_vars)) {
    echo $session_vars[$this->domain_name]['table_name'];
} ?>" class="sr-only">
          </div>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-5">
          <input id="create-table-table_comment" name="<?php echo $this->domain_name; ?>[table_comment]" type="text" value="<?php if (isset($session_vars)) {
    echo $session_vars[$this->domain_name]['table_comment'];
} ?>" class="form-control" placeholder="<?php _e('Please enter the table comment', CDBT); ?>">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-10">
          <div class="checkbox" id="automatically-add-columns1">
            <label class="checkbox-custom" data-initialize="checkbox">
              <input class="sr-only" name="<?php echo $this->domain_name; ?>[automatically_add_columns][]" type="checkbox" value="ID"<?php if (isset($session_vars)) {
              if (isset($session_vars[$this->domain_name]['automatically_add_columns']) && in_array('ID', $session_vars[$this->domain_name]['automatically_add_columns'])) {
                  ?> checked="checked"<?php
              }
          } else {
              ?> checked="checked"<?php
          ...
          <div class="checkbox" id="automatically-add-columns2">
            <label class="checkbox-custom" data-initialize="checkbox">
              <input class="sr-only" name="<?php echo $this->domain_name; ?>[automatically_add_columns][]" type="checkbox" value="created"<?php if (isset($session_vars)) {
              if (isset($session_vars[$this->domain_name]['automatically_add_columns']) && in_array('created', $session_vars[$this->domain_name]['automatically_add_columns'])) {
                  ?> checked="checked"<?php
              }
          } else {
              ?> checked="checked"<?php
          ...
          <div class="checkbox" id="automatically-add-columns3">
            <label class="checkbox-custom" data-initialize="checkbox">
              <input class="sr-only" name="<?php echo $this->domain_name; ?>[automatically_add_columns][]" type="checkbox" value="updated"<?php if (isset($session_vars)) {
              if (isset($session_vars[$this->domain_name]['automatically_add_columns']) && in_array('updated', $session_vars[$this->domain_name]['automatically_add_columns'])) {
                  ?> checked="checked"<?php
              }
          } else {
              ?> checked="checked"<?php
        ...
        <div class="col-sm-9">
          <div role="tabpanel">
            ...
            <div class="tab-content">
              <div role="tabpanel" class="tab-pane active" id="direct_sql"><textarea id="create-table-create_table_sql" name="<?php echo $this->domain_name; ?>[create_table_sql]" class="form-control" rows="10" placeholder="CREATE TABLE table_name ..."><?php if (isset($session_vars)) {
              echo esc_textarea(stripslashes_deep($session_vars[$this->domain_name]['create_table_sql']));
          } ?></textarea></div>
              <div role="tabpanel" class="tab-pane" id="table_creator"><textarea id="instance_create_table_sql" class="form-control" rows="10" disabled="disabled"><?php if (isset($session_vars)) {
              echo esc_textarea(stripslashes_deep($session_vars[$this->domain_name]['create_table_sql']));
          } ?></textarea></div>
            </div>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-10">
          <div class="spinbox disits-3" data-initialize="spinbox" id="create-table-max_show_records">
            <input type="text" name="<?php echo $this->domain_name; ?>[max_show_records]" value="<?php if (isset($session_vars)) {
              echo intval($session_vars[$this->domain_name]['max_show_records']);
          } else {
              echo intval($options['default_per_records']);
      ...
      <div class="form-group">
        ...
        <div class="col-sm-10">
          <div class="input-group input-append dropdown combobox col-sm-3" data-initialize="combobox" id="create-table-user_permission_view">
            <input type="text" name="<?php echo $this->domain_name; ?>[user_permission_view]" value="<?php if (isset($session_vars)) {
              esc_html_e($session_vars[$this->domain_name]['user_permission_view']);
          } else {
              echo 'guest';
          } ?>" class="form-control">
            <div class="input-group-btn">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-10">
          <div class="input-group input-append dropdown combobox col-sm-3" data-initialize="combobox" id="create-table-user_permission_entry">
            <input type="text" name="<?php echo $this->domain_name; ?>[user_permission_entry]" value="<?php if (isset($session_vars)) {
              echo esc_html_e($session_vars[$this->domain_name]['user_permission_entry']);
          } else {
              echo 'contributor';
          } ?>" class="form-control">
            <div class="input-group-btn">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-10">
          <div class="input-group input-append dropdown combobox col-sm-3" data-initialize="combobox" id="create-table-user_permission_edit">
            <input type="text" name="<?php echo $this->domain_name; ?>[user_permission_edit]" value="<?php if (isset($session_vars)) {
              echo esc_html_e($session_vars[$this->domain_name]['user_permission_edit']);
          } else {
              echo 'editor';
          } ?>" class="form-control">
            <div class="input-group-btn">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-9">
          <div role="tabpanel">
            ...
            <div class="tab-content">
              <div role="tabpanel" class="tab-pane active" id="direct_sql"><textarea id="modify-table-alter_table_sql" name="<?php echo $this->domain_name; ?>[alter_table_sql]" class="form-control" rows="10" placeholder="ALTER TABLE table_name ..."><?php if (isset($session_vars) && isset($session_vars['alter_table_sql'])) {
                echo esc_textarea(stripslashes_deep($session_vars['alter_table_sql']));
            } ?></textarea></div>
    ...
    <form method="post" action="<?php echo esc_url(add_query_arg([ 'page' => $this->query['page'] ])); ?>" id="cdbt-update-options-form" class="form-horizontal">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-10">
          <div class="checkbox" id="modify-table-sanitaization">
            ...
            } elseif (isset($table_options['sanitization'])) {
      ...
      <div class="form-group">
        ...
        <div class="col-sm-10">
          ...
          <?php if (isset($session_vars) && isset($session_vars['user_permission_view'])) {
              ...
              } elseif (isset($table_options['permission'])) {
                  $_current_value = implode(',', $table_options['permission']['view_global']);
              } else {
                  $_current_value = implode(',', $this->convert_cap_level(intval($table_options['roles']['view_role']) - 1));
              } ?>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-10">
          ...
          <?php if (isset($session_vars) && isset($session_vars['user_permission_entry'])) {
                  $_current_value = $session_vars['user_permission_entry'];
              } elseif (isset($table_options['permission'])) {
                  $_current_value = implode(',', $table_options['permission']['entry_global']);
              } else {
                  $_current_value = implode(',', $this->convert_cap_level(intval($table_options['roles']['input_role']) - 1));
              } ?>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-10">
          ...
          <?php if (isset($session_vars) && isset($session_vars['user_permission_edit'])) {
                  $_current_value = $session_vars['user_permission_edit'];
              } elseif (isset($table_options['permission'])) {
                  $_current_value = implode(',', $table_options['permission']['edit_global']);
              } else {
                  $_current_value = implode(',', $this->convert_cap_level(intval($table_options['roles']['edit_role']) - 1));
              } ?>
...
<?php if ($current_tab === 'operate_table' || $current_tab === 'operate_data') :
  ...
  if (isset($this->cdbt_sessions[$current_tab]) && !empty($this->cdbt_sessions[$current_tab])) {
      ...
      } elseif (array_key_exists('target_table', $this->cdbt_sessions[$current_tab])) {
          $target_table = $this->cdbt_sessions[$current_tab]['target_table'];
      } elseif (array_key_exists('operate_current_table', $this->cdbt_sessions[$current_tab])) {
      ...
      } elseif (array_key_exists('default_action', $this->cdbt_sessions[$current_tab])) {
  ...
  } elseif (in_array($target_table, $enable_table)) {
  ...
  } elseif ($current_tab === 'operate_data') {
      $operatable_buttons = [
...
?>
  ...
  <div class="well-sm">
    ...
    _e('In this section, you can perform various operations to any table. Please press an operating button that you want to perform.', CDBT);
} ?>
      <?php if ($current_tab === 'operate_data') {
    _e('In this section, you can manipulate data in the specified table. Please press the operating button that you want to perform.', CDBT);
} ?>
    </p>
  </div>
...
-->
      <div class="col-sm-9">
        <div class="pillbox" data-initialize="pillbox" id="import-table-add_first_line">
          ...
          <?php if (isset($add_first_line)) {
    if (!in_array($column_name, $add_first_line)) {
        continue;
    }
} ?>
        ...
        <input type="hidden" id="import-table-add_first_line-instance" name="<?php echo $this->domain_name; ?>[add_first_line]" value="<?php if (isset($add_first_line)) {
    echo implode(',', $add_first_line);
} ?>">
  ...
  <div class="step-pane<?php echo isset($session_var['import_result']) && $session_var['import_result'] ? ' bg-info' : ' bg-danger'; ?> alert" data-step="3" data-current-table="<?php if (array_key_exists('operate_current_table', $session_var)) {
    echo $session_var['operate_current_table'];
} ?>">
...
?>
  ...
  <input type="hidden" name="<?php echo $this->domain_name; ?>[import_current_step]" value="<?php if (isset($this->cdbt_sessions[$current_tab]['import_current_step']) && !empty($this->cdbt_sessions[$current_tab]['import_current_step'])) {
    echo $this->cdbt_sessions[$current_tab]['import_current_step'];
} else {
    echo $conponent_options['currentStep'];
} ?>">
  </form>
      ...
      <div class="col-sm-9">
        <div class="btn-group selectlist" data-resize="auto" data-initialize="selectlist" id="export-table-output_encoding">
          ...
          <?php foreach (mb_list_encodings() as $encoding) : ?>
            <li data-value="<?php echo $encoding; ?>"<?php if (isset($this->cdbt_sessions[$current_tab]['encoding']) && $this->cdbt_sessions[$current_tab]['encoding'] === $encoding) : ?> data-selected="true"<?php else : if ('utf-8' === strtolower($encoding)) {
        ?> data-selected="true"<?php
    } endif; ?>><a href="#"><?php echo $encoding; ?></a></li>
          <?php endforeach; ?>
          </ul>
...
<section id="duplicate" class="<?php if ('duplicate' === $current_action) : ?>show<?php else : ?>hidden<?php endif; ?>">
  ...
  <form method="post" action="<?php echo esc_url(add_query_arg([ 'page' => $this->query['page'] ])); ?>" class="form-horizontal">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-5">
        <input id="duplicate-table-table_name" name="<?php echo $this->domain_name; ?>[duplicate_table_name]" type="text" value="<?php if (isset($this->cdbt_sessions[$current_tab]['duplicate_table_name'])) {
            echo $this->cdbt_sessions[$current_tab]['duplicate_table_name'];
        } ?>" class="form-control" placeholder="<?php _e('Please enter a new table name', CDBT); ?>">
      ...
      <div class="col-sm-10">
        <div class="radio">
          <label class="radio-custom" data-initialize="radio" id="duplicate-table-with_data_true">
            <input class="sr-only" name="<?php echo $this->domain_name; ?>[duplicate_with_data]" type="radio" value="true"<?php if (isset($this->cdbt_sessions[$current_tab]['duplicate_with_data'])) {
            if ($this->cdbt_sessions[$current_tab]['duplicate_with_data']) : ?> checked="checked"<?php endif;
        } else {
            ?> checked="checked"<?php
        } ?>>
        ...
        <div class="radio checked">
          <label class="radio-custom" data-initialize="radio" id="duplicate-table-with_data_false">
            <input class="sr-only" name="<?php echo $this->domain_name; ?>[duplicate_with_data]" type="radio" value="false"<?php if (isset($this->cdbt_sessions[$current_tab]['duplicate_with_data'])) {
            if (!$this->cdbt_sessions[$current_tab]['duplicate_with_data']) : ?> checked="checked"<?php endif;
        } ?>>
