...
Author: snilesh
Plugin URI: http://www.snilesh.com/wordpress-pagenavi-style-plugin/
...
function wp_pn_style_deregister_styles()
{
	...
	<style type="text/css">
	.wp-pagenavi{<?php if ($options['align']=='right') {
            echo 'float:right !important; ';
        } elseif ($options['align']=='left') {
            echo 'float:left !important; ';
        } else {
            echo 'margin-left:auto !important; margin-right:auto; !important';
        } ?>}
	</style>
  <?php
    } else {
	  ...
	  .wp-pagenavi a,.wp-pagenavi a:link,.wp-pagenavi a:visited,.wp-pagenavi a:active,.wp-pagenavi span.extend { <?php if ($options['background_color']!="") {
            echo 'background:#'.$options['background_color'].' !important;';
        } ?> <?php if ($options['border_color']!="") {
            echo 'border:1px solid #'.$options['border_color'].' !important;';
        } ?> <?php if ($options['link_color']!="") {
            echo 'color:#'.$options['link_color'].' !important;';
        } ?> }
	  .wp-pagenavi a:hover,.wp-pagenavi span.current
	  {
		  <?php if ($options['hover_color']!="") {
            echo 'background:#'.$options['hover_color'].' !important;';
        } ?> <?php if ($options['border_active_color']!="") {
            echo 'border:1px solid #'.$options['border_active_color'].' !important;';
        } ?> <?php if ($options['link_active_color']!="") {
            echo 'color:#'.$options['link_active_color'].' !important;';
        } ?> 
	  }
	  .wp-pagenavi span.pages { <?php if ($options['heading_color']!="") {
            echo 'color:#'.$options['heading_color'].' !important;';
        } ?> }
	  </style>
	  <?php
    }
