...
class JSON_API_Comment
{
  ...
  public $author;  // Object (only if the user was registered & logged in)
  
  public function JSON_API_Comment($wp_comment = null)
  {
      if ($wp_comment) {
    ...
    public function import_wp_object($wp_comment)
    {
        global $json_api;
