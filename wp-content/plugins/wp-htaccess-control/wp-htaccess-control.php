...
if (! class_exists("WPhtc")) {
    class WPhtc
    {
        ...
        public function get_search_query_filter($query)
        {
        ...
        public function search_feed_link($link)
        {
        ...
        public function refresh_rewrite_rules_later()
        {
        ...
        public function filter_author_link($link)
        {
            ...
            } elseif (isset($this->data['cap']) && $this->data['cap'] != '') {
        ...
        public function filter_redirect_canonical($requested_url)
        {
            global $wp;
        ...
        public function term_ancestors($tax, $id)
        {
        ...
        public function filter_rewrite_rules($rewrite_rules)
        {
            ...
            } elseif (isset($this->data['author_archives'])) {
         ...
         * @return WP_Rewrite
         */
        public function wp_rewrite_rules($wp_rewrite)
        {
        ...
        public function hta_rules($rules)
        {
        ...
        public function remove_taxonomy_base_from_rewrite_rules($rules)
        {
        ...
        public function remove_author_base_from_rewrite_rules($author_rewrite)
        {
            if ($this->data['remove_author_base']) {
        ...
        public function filter_tax_table_actions($actions, $tag)
        {
            if ($tag->parent != 0) {
